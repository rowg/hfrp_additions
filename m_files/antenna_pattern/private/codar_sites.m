...
% SLO's Diablo Canyon Short range, and point san luis sites
...
% 25's:
% SIO sites
loc.NIC1=[-118.9213000 34.0343000]; % from sccoos site - verify
...
loc.ptm1=[-119.1100300 34.0960160]; % from sccoos site - verify
