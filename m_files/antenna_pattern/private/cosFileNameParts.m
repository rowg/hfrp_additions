...
% csqTimes=datenum(csqNames(:,10:end-3),'yy_mm_dd_HHMMSS');
%
% Run a test case:
...
if isempty(NM.Type)
    disp([fileName ' is a fileType not supported by cosFileNameParts'])
    keyboard
end
...
switch NM.Type
    ...
    case {'LOOP'}
        ...
        catch stime=datenum(fileName(11:16),'yymmdd');
        end
        NM.SiteName=fileName(6:9);
