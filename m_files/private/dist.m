...
% DIST    Computes distance (m) and bearing between points on the earth
%         using various reference spheroids, using Vincenty's formulae.
%
%         [RANGE,AF,AR]=DIST(LAT,LONG) computes the ranges RANGE (meters) between
...
%         (degrees clockwise from N) are returned in AF, AR.
%
...
%
%    SEE ALSO: http://en.wikipedia.org/wiki/Vincenty's_formulae.
%    Also, checked this vs an online calculator:
%
%    r = dist([53+(09/60)+(02/3600) 52+(12/60)+(19/3600)], ...
%                           [-001-(50/60)-(40/3600) -000-(08/60)-(33/3600)])
%    r = 155927.727 m
%
%    http://www.movable-type.co.uk/scripts/latlong-vincenty.html
%
%    Other test cases available at:
%    http://www.ngs.noaa.gov/PC_PROD/Inv_Fwd/readme.htm

% I infered the method using the web site results, that is, this reproduces
% the results of the Vincenty's, ergo it's Vincentys(?). 
% -B. Emery 25 Feb 2010
% 
% Duh! see m_idist.m and m_fdist.m
...
%Emery: this added to specify B for the wgs84 case
F=1/298.257223562997; % 298.257223563;
B=-(A.*F)+A;
...
if (NN==size(lat)), rowvec=0; %end; % It is easier if things are column vectors,
